...
echo "</tr>";
	...
	{
		echo "<form action=xoa-san-pham.php method = post>";
		echo "<tr>";
				echo "<td><input type='text' name=ProductID readonly='readonly' value=".$row['ProductID']."></td>";
				echo "<td><input type='text' name=ProductName readonly='readonly' value='".$row['ProductName']."'></td>";
				echo "<td><input type='text' name=Detail readonly='readonly' value='".$row['Detail']."'></td>";
				echo "<td><input type='number' name=Price readonly='readonly' value='".$row['Price']."'></td>";
				echo "<td><input type='text' name=Avatar readonly='readonly' value='".$row['Avatar']."'></td>";
				echo "<td><input type='text' name=CategoryID readonly='readonly' value=".$row['CategoryID']."></td>";
				echo "<td><input type='submit' name=xoasanpham value='Xóa Sản Phẩm'/></td>";
		echo "</tr>";
		echo "</form>";
	}
echo "</table>";
